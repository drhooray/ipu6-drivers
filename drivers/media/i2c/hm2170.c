...
#define HM2170_REG_SILICON_REV		0x0002
...
enum hm2170_silicon_revision {
	HM2170_SILICON_REV_B = 0,
	HM2170_SILICON_REV_D = 1,
};
...
static const struct hm2170_reg mode_1928x1088_ver_b_regs[] = {
	{0x0103, 0x00},
	{0xffff, 0x10},
	{0x0202, 0x03},
	{0x0203, 0x60},
...
static const struct hm2170_reg mode_1928x1088_ver_d_regs[] = {
	{0x0103, 0x00},
	{0xffff, 0x10},
	{0x0202, 0x03},
	{0x0203, 0x60},
...
static const struct hm2170_mode supported_modes[][1] = {
	{
		{
			.width = 1928,
			.height = 1088,
			...
			.reg_list = {
				.num_of_regs = ARRAY_SIZE(mode_1928x1088_ver_b_regs),
				.regs = mode_1928x1088_ver_b_regs,
			},
	...
	{
		{
			...
			.vts_min = HM2170_VTS_MIN,
			.reg_list = {
				.num_of_regs = ARRAY_SIZE(mode_1928x1088_ver_d_regs),
				.regs = mode_1928x1088_ver_d_regs,
			},
			.link_freq_index = HM2170_LINK_FREQ_384MHZ_INDEX,
...
struct hm2170 {
	...
	/* HM2170 silicon revision, B or D */
	enum hm2170_silicon_revision rev;
			     ...
			     struct v4l2_subdev_format *fmt)
{
	...
	mode = v4l2_find_nearest_size(supported_modes[hm2170->rev],
				      ARRAY_SIZE(supported_modes[hm2170->rev]),
				  ...
				  struct v4l2_subdev_frame_size_enum *fse)
{
	...
	if (fse->index >= ARRAY_SIZE(supported_modes[hm2170->rev]))
		return -EINVAL;

	if (fse->code != MEDIA_BUS_FMT_SGRBG10_1X10)
		return -EINVAL;

	fse->min_width = supported_modes[hm2170->rev][fse->index].width;
	fse->max_width = fse->min_width;
	fse->min_height = supported_modes[hm2170->rev][fse->index].height;
...
static int hm2170_identify_module(struct hm2170 *hm2170)
{
	...
	ret = hm2170_read_reg(hm2170, HM2170_REG_CHIP_ID, 3, &val);
	...
	hm2170->rev = rev < 0x4 ? HM2170_SILICON_REV_B :
				  HM2170_SILICON_REV_D;
...
static int hm2170_probe(struct i2c_client *client)
{
	...
	hm2170->cur_mode = &supported_modes[hm2170->rev][0];
